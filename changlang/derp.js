...
var grammar = {
    ...
    {"name": "await", "symbols": ["await$string$1", "__", "identifier"], "postprocess": helpers.makeAwait},
    ...
    {"name": "thing", "symbols": ["spawn"], "postprocess": helpers.strip},
    ...
    {"name": "spawn$string$1", "symbols": [{"literal":"s"}, {"literal":"p"}, {"literal":"a"}, {"literal":"w"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "spawn", "symbols": ["spawn$string$1", "__", "identifier", "_", "expr_tuple"], "postprocess": helpers.makeSpawn},
