...
var grammar = {
    ...
    {"name": "function_def", "symbols": [(lexer.has("DEF") ? {type: "DEF"} : DEF), "_", "identifier", "_", "thing_tuple", (lexer.has("NL") ? {type: "NL"} : NL), "block", (lexer.has("NL") ? {type: "NL"} : NL), (lexer.has("END") ? {type: "END"} : END), (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": ast.makeFunction},
    ...
    {"name": "block$subexpression$1$subexpression$1", "symbols": [{"literal":";"}, "_"]},
    ...
    {"name": "constant", "symbols": ["number"], "postprocess": ast.makeNumber},
    ...
    {"name": "number", "symbols": [{"literal":"-"}, (lexer.has("NUMBER") ? {type: "NUMBER"} : NUMBER)]},
    ...
    {"name": "thing_tuple", "symbols": [{"literal":"("}, "_", "thing_list", "_", {"literal":")"}], "postprocess": ast.makeTuple},
    {"name": "thing_tuple", "symbols": [{"literal":"("}, "_", {"literal":")"}], "postprocess": ast.makeTuple},
    {"name": "thing_list", "symbols": ["_thing_list"], "postprocess": ast.makeIdentList},
    {"name": "thing_list$ebnf$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": id},
    {"name": "thing_list$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "thing_list", "symbols": ["_thing_list", "_", {"literal":","}, "_", "thing_list$ebnf$1"], "postprocess": ast.makeIdentList},
    {"name": "_thing_list", "symbols": ["thing"], "postprocess": ast.flattenAndStrip},
    {"name": "_thing_list$ebnf$1$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "_thing_list$ebnf$1$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "_thing_list$ebnf$1", "symbols": ["_thing_list$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "_thing_list$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "_thing_list", "symbols": ["_thing_list", "_", {"literal":","}, "_thing_list$ebnf$1", "thing"], "postprocess": ast.flattenAndStrip},
    ...
    {"name": "_repack_list", "symbols": ["expr_blob"]},
    ...
    {"name": "_repack_list", "symbols": ["_repack_list", "_", {"literal":","}, "_", "_repack_list$ebnf$2", "expr_blob"]},
    {"name": "expr_blob", "symbols": [(lexer.has("OPEN_BLOB") ? {type: "OPEN_BLOB"} : OPEN_BLOB), "_", "expr", "_", (lexer.has("CLOSE_BLOB") ? {type: "CLOSE_BLOB"} : CLOSE_BLOB)], "postprocess": ast.makeBlob},
    {"name": "name_blob", "symbols": [(lexer.has("OPEN_BLOB") ? {type: "OPEN_BLOB"} : OPEN_BLOB), "_", "identifier", "_", (lexer.has("CLOSE_BLOB") ? {type: "CLOSE_BLOB"} : CLOSE_BLOB)], "postprocess": ast.makeBlob},
    ...
    {"name": "_unpack", "symbols": ["identifier"]},
    {"name": "_unpack", "symbols": ["unpack"]},
    {"name": "_unpack", "symbols": ["name_blob"]},
    {"name": "_unpack$ebnf$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": id},
    {"name": "_unpack$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "_unpack", "symbols": ["_unpack", "_", {"literal":","}, "_", "_unpack$ebnf$1", "name_blob"]},
    {"name": "_unpack$ebnf$2", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": id},
    {"name": "_unpack$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "_unpack", "symbols": ["_unpack", "_", {"literal":","}, "_", "_unpack$ebnf$2", "identifier"]},
    {"name": "_unpack$ebnf$3", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": id},
    {"name": "_unpack$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "_unpack", "symbols": ["_unpack", "_", {"literal":","}, "_", "_unpack$ebnf$3", "unpack"]},
