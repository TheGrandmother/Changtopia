...
var grammar = {
    ...
    {"name": "closure$string$1", "symbols": [{"literal":"d"}, {"literal":"e"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "closure$string$2", "symbols": [{"literal":"e"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "closure$ebnf$1", "symbols": []},
    {"name": "closure$ebnf$1", "symbols": ["closure$ebnf$1", {"literal":"\n"}], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "closure", "symbols": ["closure$string$1", "_", "name_tuple", "_", {"literal":"\n"}, "_", "block", "_", {"literal":"\n"}, "_", "closure$string$2", "closure$ebnf$1"], "postprocess": ast.makeClosure},
